        ...
        return (
            <div className="container">
                ...
                <div className="row" style={{ paddingTop: '50px'}}>
                    ...
                    <div className="col">
                        <div className="card" style={{ width: '20rem', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)', alignItems:'center' }}>
                            <img className="card-img-top" src="https://png.pngtree.com/svg/20161229/e7a5cf5c9e.svg" alt="Card image cap" style={{width :200, height:200, alignItems: 'center'}} />
